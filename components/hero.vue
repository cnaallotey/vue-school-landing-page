<template>
  <section class="w-full bg-primary-500 pt-3">
    <Navbar />
    <div class="w-fit mx-auto mt-[50px] lg:mt-[25px]">
      <h1
        class="font-heading text-[56px] md:text-[100px] lg:text-[140px] tracking-normal text-center text-white font-normal uppercase"
      >
        Black Friday sale
      </h1>
      <h1
