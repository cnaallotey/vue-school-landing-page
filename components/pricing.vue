<template>
  <div class="w-full mt-20 font-sans">
    <div class="w-full bg-primary-500 px-4 py-[34px]">
      ...
      <div class="mx-auto w-fit mt-10">
        <div class="w-full p-[6px] flex rounded-full bg-primary-700 bg-opacity-100">
          <button
            class="py-3 px-8 rounded-full bg-button font-medium font-sans text-white uppercase tracking-[0.37px]"
          >
            yearly plan
          </button>
          <button
            class="py-3 px-8 rounded-full font-medium font-sans text-white uppercase tracking-[0.37px]"
          >
            Lifetime plan
          </button>
          <button
      ...
      <div class="max-w-xl mx-auto bg-white rounded-md mt-24">
        <div class="h-2 bg-button w-full rounded-t-md"></div>
        ...
        <div class="max-w-md mx-auto mt-5 pl-20 pb-1 border-b border-gray-200">
          <p
            class="text-base font-normal text-gray-600 inline-flex items-center space-x-2"
          >
            <span
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 text-[#67d553]"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
                ...
                /></svg
            ></span>
            <span>22 Courses 300 Videos 20 Hours</span>
          </p>
        </div>
        <div class="max-w-md mx-auto mt-5 pl-20 pb-1 border-b border-gray-200">
          <p
